...
test("e2e: built bundle runs standalone, handshakes, lists all tools, gates player tools", async (t) => {
  ...
  try {
    ...
    assert.equal(tools.length, 19, "every tool should register in the built bundle");
